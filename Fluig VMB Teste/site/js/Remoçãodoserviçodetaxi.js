var htmlTitle = 'Remoção do serviço de taxi - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 7;

var currentProcess = Properties("id,Remoçãodoserviçodetaxi|name,Remoção do serviço de taxi|version,1");
var processImageName = 'Remoção do serviço de taxi.png';
...
componentList.push(Component('rect','230.0,194.0,336.0,264.0','Atividade','tasknormal.png',Properties("id,task5|name,Realizar exclusão")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Start")));
componentList.push(Component('circle','427.5,228.5,17.5','Final','endnormal.png',Properties("id,endevent9|name,Fim")));
componentList.push(Component('rect','40.0,155.0,641.0,300.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Administração")));
componentList.push(Component('rect','40.0,10.0,641.0,155.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Solicitante")));
componentList.push(Component('rect','10.0,10.0,40.0,300.0','Pool','pool.png',Properties("id,pool1|name,Remoção dos serviços de táxi")));
