var htmlTitle = 'Solicitacao de Eventos - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 10;

var currentProcess = Properties("id,SolicitacaodeEventos|name,Solicitacao de Eventos|version,1");
var processImageName = 'Solicitacao de Eventos.png';
...
componentList.push(Component('rect','220.0,149.0,326.0,219.0','Atividade','tasknormal.png',Properties("id,task5|name,Aprovar solicitação")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Preencher solicitação")));
componentList.push(Component('rect','360.0,280.0,466.0,350.0','Atividade','tasknormal.png',Properties("id,task9|name,Atender solicitação")));
componentList.push(Component('circle','737.5,311.5,17.5','Final','endnormal.png',Properties("id,endevent11|name,Fim")));
componentList.push(Component('rect','380.0,140.0,440.0,242.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway14|name,Aprovado?")));
componentList.push(Component('circle','517.5,187.5,17.5','Final','endnormal.png',Properties("id,endevent16|name,Fim")));
componentList.push(Component('rect','40.0,250.0,841.0,371.0','SwimLane','type.swim.lane.png',Properties("id,swimlane13|name,Assistente Adm")));
componentList.push(Component('rect','40.0,130.0,841.0,250.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Aprovador")));
componentList.push(Component('rect','40.0,10.0,841.0,130.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Solicitante")));
componentList.push(Component('rect','10.0,10.0,40.0,371.0','Pool','pool.png',Properties("id,pool1|name,Solicitação de eventos")));
