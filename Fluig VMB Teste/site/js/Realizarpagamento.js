var htmlTitle = 'Realizar pagamento - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 7;

var currentProcess = Properties("id,Realizarpagamento|name,Realizar pagamento|version,1");
var processImageName = 'Realizar pagamento.png';
...
componentList.push(Component('circle','167.5,58.5,17.5','Inicial','startnormal.png',Properties("id,startevent4|name,Início")));
componentList.push(Component('rect','510.0,120.0,616.0,190.0','Atividade','tasknormal.png',Properties("id,task13|name,Confirmar pagamento")));
componentList.push(Component('circle','687.5,154.5,17.5','Final','endnormal.png',Properties("id,endevent18|name,Fim")));
componentList.push(Component('rect','350.0,120.0,456.0,190.0','Atividade','tasknormal.png',Properties("id,task20|name,Transmitir para banco")));
componentList.push(Component('rect','350.0,217.0,456.0,287.0','Manual','taskmanual.png',Properties("id,manualtask22|name,Autorizar pagamentos")));
componentList.push(Component('rect','210.0,113.0,316.0,197.0','Atividade','tasknormal.png',Properties("id,task25|name,Preparar remessa bancária")));
componentList.push(Component('rect','210.0,24.0,316.0,94.0','Atividade','tasknormal.png',Properties("id,task26|name,Liberar pagamento")));
componentList.push(Component('rect','40.0,202.0,841.0,300.0','SwimLane','type.swim.lane.png',Properties("id,swimlane9|name,Procuradores")));
componentList.push(Component('rect','40.0,106.0,841.0,202.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Assist. Financ.")));
componentList.push(Component('rect','40.0,10.0,841.0,106.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Controller")));
...
processList.push(Properties("id,DadosdegestãoConexãoEscola|name,Dados de gestão Conexão Escola"));
...
processList.push(Properties("id,Realizarpagamento|name,Realizar pagamento"));
