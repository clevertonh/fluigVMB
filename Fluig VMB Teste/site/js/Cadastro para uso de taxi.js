var htmlTitle = 'Cadastro para uso de taxi - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 2;

var currentProcess = Properties("id,Cadastro para uso de taxi|name,Cadastro para uso de taxi|version,2");
var processImageName = 'Cadastro para uso de taxi.png';
...
componentList.push(Component('circle','147.5,62.5,17.5','Inicial','startnormal.png',Properties("id,startevent4|name,Início")));
componentList.push(Component('rect','210.0,20.0,431.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Solicite o cadastramento de seus funcionários nos serviços de taxi")));
componentList.push(Component('rect','180.0,157.0,286.0,227.0','Atividade','tasknormal.png',Properties("id,task14|name,Aprovar cadastramento")));
componentList.push(Component('rect','340.0,141.0,400.0,243.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway20|name,Aprovado?")));
componentList.push(Component('circle','457.5,191.5,17.5','Final','endnormal.png',Properties("id,endevent22|name,Fim")));
componentList.push(Component('circle','527.5,311.5,17.5','Final','endnormal.png',Properties("id,endevent26|name,Fim")));
componentList.push(Component('rect','320.0,277.0,426.0,347.0','Atividade','tasknormal.png',Properties("id,task29|name,Cadastrar e liberar")));
componentList.push(Component('rect','40.0,250.0,841.0,371.0','SwimLane','type.swim.lane.png',Properties("id,swimlane19|name,Administração")));
componentList.push(Component('rect','40.0,130.0,841.0,250.0','SwimLane','type.swim.lane.png',Properties("id,swimlane9|name,Aprovador")));
componentList.push(Component('rect','40.0,10.0,841.0,130.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Líder")));
componentList.push(Component('rect','10.0,10.0,40.0,371.0','Pool','pool.png',Properties("id,pool1|name,Solicitação de cadastramento para uso de táxi")));
