var htmlTitle = 'Renovaçao de Estagio - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 1;

var currentProcess = Properties("id,RenovaçaodeEstagio|name,Renovaçao de Estagio|version,1");
var processImageName = 'Avaliação de Estagio.png';
...
componentList.push(Component('rect','40.0,390.0,841.0,581.0','SwimLane','type.swim.lane.png',Properties("id,bpmnswimlane4|name,Assistente de DP")));
componentList.push(Component('rect','40.0,200.0,841.0,390.0','SwimLane','type.swim.lane.png',Properties("id,bpmnswimlane3|name,Analista de R e S")));
componentList.push(Component('rect','40.0,10.0,841.0,200.0','SwimLane','type.swim.lane.png',Properties("id,bpmnswimlane2|name,Gerente de área")));
componentList.push(Component('rect','10.0,10.0,40.0,581.0','Pool','pool.png',Properties("id,bpmnpool1|name,Pool")));
componentList.push(Component('circle','167.5,99.5,17.5','Inicial','startnormal.png',Properties("id,startevent6|name,Início")));
componentList.push(Component('rect','110.0,262.0,216.0,332.0','Atividade','tasknormal.png',Properties("id,task7|name,Avaliar renovação")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask8|name,Solicitar renovação")));
componentList.push(Component('rect','430.0,320.0,536.0,376.0','Atividade','tasknormal.png',Properties("id,task10|name,Elaborar aditivo")));
componentList.push(Component('rect','430.0,440.0,536.0,496.0','Atividade','tasknormal.png',Properties("id,task11|name,Arquivar")));
componentList.push(Component('circle','677.5,470.5,17.5','Final','endnormal.png',Properties("id,endevent12|name,Fim")));
componentList.push(Component('rect','430.0,213.0,535.0,297.0','Subprocesso','subprocessnormal.png',Properties("id,subprocess13|name,Encerramento de contrato de estágio|subprocessid,Solicitar Encerramento de Estagio")));
componentList.push(Component('circle','617.5,257.5,17.5','Final','endnormal.png',Properties("id,endevent14|name,Fim")));
componentList.push(Component('rect','300.0,246.0,360.0,348.0','Inclusivo','gatewayinclusive.png',Properties("id,inclusivegateway27|name,Exclusivo")));
