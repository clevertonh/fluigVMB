var htmlTitle = 'Solicitacao de Viagem - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 13;

var currentProcess = Properties("id,Solicitacao de Viagem|name,Solicitacao de Viagem|version,300");
var processImageName = 'Solicitacao de Viagem.png';
...
componentList.push(Component('rect','49.0,454.0,1541.0,671.0','SwimLane','type.swim.lane.png',Properties("id,bpmnswimlane4|name,Hospitalidade")));
componentList.push(Component('rect','49.0,237.0,1541.0,454.0','SwimLane','type.swim.lane.png',Properties("id,bpmnswimlane3|name,Aprovador")));
componentList.push(Component('rect','49.0,20.0,1541.0,237.0','SwimLane','type.swim.lane.png',Properties("id,bpmnswimlane2|name,Solicitante")));
componentList.push(Component('rect','19.0,20.0,49.0,671.0','Pool','pool.png',Properties("id,bpmnpool1|name,Solicitação de Viagem")));
componentList.push(Component('circle','157.5,130.5,17.5','Inicial','startnormal.png',Properties("id,startevent4|name,Solicitar viagem")));
componentList.push(Component('rect','290.0,290.0,350.0,406.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway9|name,Verificar aprovação?")));
componentList.push(Component('rect','270.0,510.0,376.0,580.0','Atividade','tasknormal.png',Properties("id,task13|name,Comprar passagem")));
componentList.push(Component('rect','790.0,96.0,896.0,166.0','Atividade','tasknormal.png',Properties("id,task33|name,Obter bilhete e/ou voucher")));
componentList.push(Component('rect','1030.0,73.0,1090.0,189.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway60|name,Pediu cancelamento?")));
componentList.push(Component('rect','1010.0,494.0,1116.0,564.0','Atividade','tasknormal.png',Properties("id,task64|name,Registrar cancelamento")));
componentList.push(Component('circle','1487.5,527.5,17.5','Final','endnormal.png',Properties("id,endevent77|name,Reembolso confirmado")));
componentList.push(Component('circle','1217.5,130.5,17.5','Final','endnormal.png',Properties("id,endevent78|name,Viagem finalizada")));
componentList.push(Component('rect','1320.0,494.0,1426.0,564.0','Atividade','tasknormal.png',Properties("id,task79|name,Confirmar reembolso")));
componentList.push(Component('rect','1190.0,480.0,1250.0,582.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway80|name,Reembolso?")));
componentList.push(Component('circle','1217.5,637.5,17.5','Final','endnormal.png',Properties("id,endevent83|name,Credito confirmado")));
componentList.push(Component('rect','520.0,480.0,580.0,596.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway87|name,Pediu cancelamento?")));
componentList.push(Component('circle','447.5,347.5,17.5','Final','endnormal.png',Properties("id,endevent92|name,Reprovado")));
componentList.push(Component('rect','500.0,90.0,606.0,160.0','Atividade','tasknormal.png',Properties("id,task93|name,Cancelar solicitação")));
componentList.push(Component('circle','677.5,127.5,17.5','Final','endnormal.png',Properties("id,endevent95|name,Cancelar solicitação")));
componentList.push(Component('rect','100.0,313.0,206.0,383.0','Usuário','taskuser.png',Properties("id,usertask97|name,Realizar Aprovação")));
componentList.push(Component('rect','270.0,100.0,376.0,184.0','Atividade','tasknormal.png',Properties("id,task98|name,Corrigir Solicitação de Viagem")));
