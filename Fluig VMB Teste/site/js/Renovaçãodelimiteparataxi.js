var htmlTitle = 'Renovação de limite para taxi - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 8;

var currentProcess = Properties("id,Renovaçãodelimiteparataxi|name,Renovação de limite para taxi|version,1");
var processImageName = 'Renovação de limite para taxi.png';
...
componentList.push(Component('circle','137.5,62.5,17.5','Inicial','startnormal.png',Properties("id,startevent4|name,Início")));
componentList.push(Component('rect','200.0,20.0,305.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Start")));
componentList.push(Component('rect','350.0,326.0,456.0,382.0','Atividade','tasknormal.png',Properties("id,task14|name,Liberar limite")));
componentList.push(Component('circle','547.5,353.5,17.5','Final','endnormal.png',Properties("id,endevent16|name,Fim")));
componentList.push(Component('rect','130.0,189.0,236.0,245.0','Atividade','tasknormal.png',Properties("id,task19|name,Aprovar")));
componentList.push(Component('rect','370.0,166.0,430.0,268.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway21|name,Exclusivo")));
componentList.push(Component('circle','547.5,217.5,17.5','Final','endnormal.png',Properties("id,endevent23|name,Fim")));
componentList.push(Component('rect','40.0,284.0,751.0,421.0','SwimLane','type.swim.lane.png',Properties("id,swimlane9|name,Administração")));
componentList.push(Component('rect','40.0,147.0,751.0,284.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Aprovador")));
componentList.push(Component('rect','40.0,10.0,751.0,147.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Funcionário")));
componentList.push(Component('rect','10.0,10.0,40.0,421.0','Pool','pool.png',Properties("id,pool1|name,Renovação de limite para taxi")));
