var htmlTitle = 'Encerramento de contrato de estagio - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 4;

var currentProcess = Properties("id,Encerramento de contrato de estagio|name,Encerramento de contrato de estagio|version,1");
var processImageName = 'Encerramento de contrato de estagio.png';
...
componentList.push(Component('rect','210.0,207.0,316.0,277.0','Atividade','tasknormal.png',Properties("id,task5|name,Preparar documentos")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Preencher formulários")));
componentList.push(Component('rect','420.0,210.0,526.0,266.0','Atividade','tasknormal.png',Properties("id,task11|name,Arquivar")));
componentList.push(Component('circle','697.5,241.5,17.5','Final','endnormal.png',Properties("id,endevent13|name,Fim")));
componentList.push(Component('rect','210.0,370.0,316.0,440.0','Atividade','tasknormal.png',Properties("id,task16|name,Calcular rescisão")));
componentList.push(Component('circle','447.5,407.5,17.5','Final','endnormal.png',Properties("id,endevent19|name,Fim")));
componentList.push(Component('rect','40.0,316.0,841.0,471.0','SwimLane','type.swim.lane.png',Properties("id,swimlane15|name,Assistente de DP")));
componentList.push(Component('rect','40.0,163.0,841.0,316.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Analista de R e S")));
componentList.push(Component('rect','40.0,10.0,841.0,163.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Gerente de área")));
componentList.push(Component('rect','10.0,10.0,40.0,471.0','Pool','pool.png',Properties("id,pool1|name,Pool")));
