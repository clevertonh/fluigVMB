var htmlTitle = 'Dados de gestão Conexão Escola - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 4;

var currentProcess = Properties("id,DadosdegestãoConexãoEscola|name,Dados de gestão Conexão Escola|version,1");
var processImageName = 'Dados de gestão Conexão Escola.png';
...
componentList.push(Component('rect','260.0,208.0,366.0,264.0','Atividade','tasknormal.png',Properties("id,task5|name,Act1")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Start")));
componentList.push(Component('circle','462.5,247.5,17.5','Final','endnormal.png',Properties("id,endevent9|name,Fim")));
