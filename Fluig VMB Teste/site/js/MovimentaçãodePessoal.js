var htmlTitle = 'Movimentação de Pessoal - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 5;

var currentProcess = Properties("id,MovimentaçãodePessoal|name,Movimentação de Pessoal|version,1");
var processImageName = 'Movimentação de Pessoal.png';
...
componentList.push(Component('circle','457.5,237.5,17.5','Final','endnormal.png',Properties("id,endevent9|name,Fim")));
...
componentList.push(Component('rect','40.0,10.0,841.0,155.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Analista de R e S")));
