var htmlTitle = 'Solicitação de serviço de Cartório - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 14;

var currentProcess = Properties("id,SolicitacaodeservicodeCartorio|name,Solicitação de serviço de Cartório|version,1");
var processImageName = 'Solicitacao de serviço de Cartorio.png';
...
componentList.push(Component('rect','220.0,149.0,326.0,205.0','Atividade','tasknormal.png',Properties("id,task5|name,Aprovar")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Start")));
componentList.push(Component('rect','220.0,259.0,326.0,329.0','Atividade','tasknormal.png',Properties("id,task12|name,Enviar para cartório")));
componentList.push(Component('circle','417.5,286.5,17.5','Final','endnormal.png',Properties("id,endevent14|name,Fim")));
componentList.push(Component('rect','40.0,230.0,841.0,341.0','SwimLane','type.swim.lane.png',Properties("id,swimlane11|name,SwimLane")));
componentList.push(Component('rect','40.0,120.0,841.0,230.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Assignee")));
componentList.push(Component('rect','40.0,10.0,841.0,120.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Reporter")));
componentList.push(Component('rect','10.0,10.0,40.0,341.0','Pool','pool.png',Properties("id,pool1|name,Pool")));
