var htmlTitle = 'Agenda de viagem - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 0;

var currentProcess = Properties("id,Agendadeviagem|name,Agenda de viagem|version,10");
var processImageName = 'Agenda de viagem.png';
...
componentList.push(Component('circle','167.5,99.5,17.5','Inicial','startnormal.png',Properties("id,startevent4|name,Cadastrar agenda de viagem")));
componentList.push(Component('rect','400.0,240.0,506.0,310.0','Atividade','tasknormal.png',Properties("id,task5|name,Aprovar agenda")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Cadastrar agenda")));
componentList.push(Component('rect','610.0,69.0,716.0,125.0','Atividade','tasknormal.png',Properties("id,task13|name,Revisar agenda")));
componentList.push(Component('rect','430.0,46.0,490.0,162.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway18|name,Agenda alterada?")));
componentList.push(Component('circle','367.5,112.5,17.5','Final','endnormal.png',Properties("id,endevent21|name,Agenda finalizada")));
componentList.push(Component('rect','630.0,220.0,690.0,336.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway25|name,Agenda aprovada?")));
componentList.push(Component('circle','777.5,267.5,17.5','Final','endnormal.png',Properties("id,endevent28|name,Agenda reprovada")));
componentList.push(Component('rect','40.0,180.0,811.0,351.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Aprovador")));
componentList.push(Component('rect','40.0,10.0,811.0,180.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Solicitante")));
componentList.push(Component('rect','10.0,10.0,40.0,351.0','Pool','pool.png',Properties("id,pool1|name,Agenda de viagem")));
