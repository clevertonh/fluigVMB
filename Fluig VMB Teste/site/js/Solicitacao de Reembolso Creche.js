var htmlTitle = 'Solicitacao de Reembolso Creche - Fluig Documental Process Site';
var headerString = 'Fluig VMB Teste - Fluig Documental Process Site';
var selectedTab = 6;

var currentProcess = Properties("id,Solicitacao de Reembolso Creche|name,Solicitacao de Reembolso Creche|version,8");
var processImageName = 'Reembolso Auxilio Creche.png';
...
componentList.push(Component('circle','157.5,64.5,17.5','Inicial','startnormal.png',Properties("id,startevent4|name,Início")));
componentList.push(Component('rect','120.0,187.0,226.0,257.0','Atividade','tasknormal.png',Properties("id,task5|name,Validar documento")));
componentList.push(Component('rect','320.0,171.0,380.0,273.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway21|name,Validado?")));
componentList.push(Component('rect','300.0,475.0,406.0,545.0','Atividade','tasknormal.png',Properties("id,task27|name,Aprovar pagamento")));
componentList.push(Component('rect','550.0,460.0,610.0,562.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway35|name,Aprovado?")));
componentList.push(Component('circle','667.5,511.5,17.5','Cancelamento','endcancel.png',Properties("id,endcancel43|name,Reprovado")));
componentList.push(Component('circle','457.5,218.5,17.5','Cancelamento','endcancel.png',Properties("id,endcancel44|name,Reprovado")));
componentList.push(Component('rect','300.0,325.0,406.0,409.0','Atividade','tasknormal.png',Properties("id,task48|name,Validar informações financeiras")));
componentList.push(Component('rect','530.0,184.0,636.0,254.0','Atividade','tasknormal.png',Properties("id,task51|name,Lançar pagamento")));
componentList.push(Component('rect','1000.0,887.0,1106.0,957.0','Manual','taskmanual.png',Properties("id,manualtask58|name,Autorizar pagamentos")));
componentList.push(Component('rect','1000.0,607.0,1106.0,677.0','Manual','taskmanual.png',Properties("id,manualtask67|name,Transmitir para banco")));
componentList.push(Component('rect','1290.0,584.0,1350.0,700.0','Exclusivo','gatewayexclusive.png',Properties("id,exclusivegateway73|name,Pgto confirmado?")));
componentList.push(Component('circle','1317.5,98.5,17.5','Final','endnormal.png',Properties("id,endevent75|name,Pagamento Confirmado")));
componentList.push(Component('circle','1417.5,641.5,17.5','Link','intermediatelink.png',Properties("id,intermediatelink77|name,Intermediário")));
componentList.push(Component('circle','777.5,641.5,17.5','Recebimento Link','intermediatelinkreceive.png',Properties("id,intermediatelinkreceive79|name,Intermediário")));
componentList.push(Component('rect','830.0,600.0,936.0,684.0','Manual','taskmanual.png',Properties("id,manualtask86|name,Preparar remessa bancária")));
componentList.push(Component('rect','1150.0,607.0,1256.0,677.0','Atividade','tasknormal.png',Properties("id,task88|name,Confirmar pagamento")));
componentList.push(Component('rect','670.0,740.0,776.0,810.0','Manual','taskmanual.png',Properties("id,manualtask94|name,Liberar para baixa")));
componentList.push(Component('rect','40.0,710.0,1471.0,850.0','SwimLane','type.swim.lane.png',Properties("id,swimlane81|name,Controller")));
componentList.push(Component('rect','40.0,850.0,1471.0,990.0','SwimLane','type.swim.lane.png',Properties("id,swimlane65|name,Procuradores")));
componentList.push(Component('rect','40.0,570.0,1471.0,710.0','SwimLane','type.swim.lane.png',Properties("id,swimlane64|name,Assist. Financeiro")));
componentList.push(Component('rect','40.0,290.0,1471.0,430.0','SwimLane','type.swim.lane.png',Properties("id,swimlane47|name,Gestor imediato")));
componentList.push(Component('rect','40.0,430.0,1471.0,570.0','SwimLane','type.swim.lane.png',Properties("id,swimlane39|name,Gerente de P&ampC")));
componentList.push(Component('rect','40.0,150.0,1471.0,290.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Assistente de DP")));
componentList.push(Component('rect','40.0,10.0,1471.0,150.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Solicitante")));
componentList.push(Component('rect','10.0,10.0,40.0,990.0','Pool','pool.png',Properties("id,pool1|name,Solicitação de reembolso creche")));
