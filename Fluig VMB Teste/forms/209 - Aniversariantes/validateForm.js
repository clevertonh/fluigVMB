function validateForm(form){
	if(form.getValue("fullLocation")==null||form.getValue("fullLocation")==""){
		throw i18n.translate("kit.aniversary.validation.fullLocation")}
	...
	if(isNaN(form.getValue("fullLocation"))){
		throw i18n.translate("kit.aniversary.validation.dayNaN")}
